...
var registerBackendKeyChan = make(chan registerBackendKeyMessage)
var deregisterBackedKeyChan = make(chan deregisterBackendKeyMessage)
var getBackendForBackendKeyChan = make(chan getBackendForBackendKeyMessage)
